...
{
    class ScheduleElementTV4
    {
        public string data_tv { get; set; }
        ...
        public string Uwagi_planowana_pozycja { get; set; }

        public ScheduleElementTV4() { }

        public sealed class MyClassMap : CsvClassMap<ScheduleElementTV4>
        {
            public MyClassMap()
            {
                Map(m => m.data_tv).Name("data_tv");
                ...
                Map(m => m.Uwagi_planowana_pozycja).Name("Uwagi, planowana pozycja");
            }
        }
    }
}
